let handler = async (m, {conn, text, config}) => {
    ...
    const channelId = config?.cenel?.id || '120363420838251363@newsletter';
    ...
    await conn.sendMessage(channelId, {
        ...
        contextInfo: {
            ...
            externalAdReply: {
                title: "ALI Maoie", 
                body: "هذه رسالة من Nataly الذكية | NATALY AI BOT",
...
handler.help = ['sent-to-channel'];
handler.arabic = ['الى-القناه'];
handler.command = ['send-to-channel'];
handler.tags = ['owner'];
handler.owner = true
